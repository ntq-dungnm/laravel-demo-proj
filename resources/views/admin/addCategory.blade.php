        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <form method="POST" id="createproduct-form" autocomplete="off" class="needs-validation"
                        novalidate>
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label class="form-label" for="product-title-input">Category
                                                Title</label>
                                        ...
                                        <div>
                                            ...
                                            <input id="ckeditor-classic" name="category_descriptions">
                                             </input>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Category Gallery</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-4">
                                        ...
                                        <div>
                                            <h5 class="fs-14 mb-1">Category Gallery</h5>
                                            <p class="text-muted">Add Category Gallery Images.</p>
                                ...
                                <div class="card">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="manufacturer-name-input">Category Slug</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="stocks-input" placeholder="Stocks"
                                                    ...
                                                    <div class="col-lg-3 col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="orders-input" placeholder="Orders"
                                    ...
                                    <!-- end card body -->
                                                    ...
                                                    <div class="text-end mb-3">
                                                        <button type="submit"
                                                            class="btn btn-primary w-sm">Submit</button>
                                                    </div>
                                                </div>
                                                <!-- end col -->

                                            ...
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a href="apps-ecommerce-add-product.html"
                                                        class="btn btn-primary" id="addproduct-btn"><i
                                                ...
                                                <table role="grid" class="gridjs-table" style="height: auto;">
                                                    <thead class="gridjs-thead">
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <th data-column-id="published"
                                                                ...
                                                                <div class="gridjs-th-content">Published</div><button
                                                                    tabindex="-1"
                                                                    aria-label="Sort column ascending"
                                                                    title="Sort column ascending"
                                                                    class="gridjs-sort gridjs-sort-neutral"></button>
                                                    ...
                                                    <tbody class="gridjs-tbody">
                                                        @foreach ($allProducts as $product)
                                                            <tr class="gridjs-tr">
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="flex-grow-1">
                                                                                ...
                                                                                <p class="text-muted mb-0">Category :
                                                                                    <span
                                                                                        class="fw-medium">{{ $product->category_title }}</span>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </span>
                                                                ...
                                                                <td data-column-id="published" class="gridjs-td">
                                                                    <span>{{ $product->created_at }}<small
                                                                            class="text-muted ms-1"></small></span>
                                                                </td>
                                                        ...
                                                        {{-- <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>06 Jan, 2021<small class="text-muted ms-1">01:31
                                                                        PM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="product" class="gridjs-td"><span>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 mb-1"><a
                                                                                    href="apps-ecommerce-product-details.html"
                                                                                    class="text-dark">350 ml Glass
                                                                                    Grocery Container</a></h5>
                                                                            <p class="text-muted mb-0">Category :
                                                                                <span class="fw-medium">Grocery</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </span></td>
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>26 Mar, 2021<small class="text-muted ms-1">11:40
                                                                        AM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="product" class="gridjs-td"><span>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 mb-1"><a
                                                                                    href="apps-ecommerce-product-details.html"
                                                                                    class="text-dark">Fabric Dual Tone
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>19 Apr, 2021<small class="text-muted ms-1">02:51
                                                                        PM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="product" class="gridjs-td"><span>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 mb-1"><a
                                                                                    href="apps-ecommerce-product-details.html"
                                                                                    class="text-dark">Crux Motorsports
                                                                                    Helmet</a></h5>
                                                                            <p class="text-muted mb-0">Category :
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>30 Mar, 2021<small class="text-muted ms-1">09:42
                                                                        AM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"
                                                        ...
                                                        <tr class="gridjs-tr">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 mb-1"><a
                                                                                    ...
                                                                                    T-Shirts (Blue)</a></h5>
                                                                            <p class="text-muted mb-0">Category :
                                                                                <span class="fw-medium">Fashion</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </span></td>
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>12 Oct, 2021<small class="text-muted ms-1">04:55
                                                                        PM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>15 May, 2021<small class="text-muted ms-1">03:40
                                                                        PM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="product" class="gridjs-td"><span>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 mb-1"><a
                                                                                    href="apps-ecommerce-product-details.html"
                                                                                    class="text-dark">Sweatshirt for
                                                                                    Men (Pink)</a></h5>
                                                                            <p class="text-muted mb-0">Category :
                                                                                <span class="fw-medium">Fashion</span>
                                                                            </p>
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>21 Jun, 2021<small class="text-muted ms-1">12:18
                                                                        PM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="product" class="gridjs-td"><span>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="flex-shrink-0 me-3">
                                                                            <div
                                                                                class="avatar-sm bg-light rounded p-1">
                                                                                <img src="assets/images/products/img-9.png"
                                                                                    alt=""
                                                                                    class="img-fluid d-block"></div>
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>15 Jan, 2021<small class="text-muted ms-1">10:29
                                                                        PM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"
                                                        ...
                                                        <tr class="gridjs-tr">
                                                            ...
                                                            <td data-column-id="product" class="gridjs-td"><span>
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <h5 class="fs-14 mb-1"><a
                                                                                    href="apps-ecommerce-product-details.html"
                                                                                    class="text-dark">Travel Carrying
                                                                                    Pouch Bag</a></h5>
                                                                            <p class="text-muted mb-0">Category :
                                                            ...
                                                            <td data-column-id="published" class="gridjs-td">
                                                                <span>15 Jun, 2021<small class="text-muted ms-1">03:51
                                                                        PM</small></span></td>
                                                            <td data-column-id="action" class="gridjs-td"><span>
                                                                    <div class="dropdown"><button
                                                                            class="btn btn-soft-secondary btn-sm dropdown"

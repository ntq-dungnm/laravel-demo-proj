                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Enter Product Description" name="descriptions" value="{{ $thisProduct->description }}">
                                                ...
                                                <div class="position-relative d-inline-block">
                                                    ...
                                                    <div class="avatar-lg">
                                                        <div class="avatar-title bg-light rounded">
                                                            <img src="{{ $thisProduct->thumnail }}" id="product-img"
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="choices-publish-status-input"
                                                data-choices data-choices-search-false name="status">
